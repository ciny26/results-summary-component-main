<template>
    <div class="cont cont2">
      <h4 style="color:black">Summary</h4>
        <div v-for="item in items" :key="item.id" :style="{backgroundColor: item.Background}" class="skill_cont" >
            <div v-html="item.svg"></div>
            <h4 :style="{color:item.Tcolor}" class="skill_name">{{ item.Skill }}</h4>
            <p style="color: black;"><strong>{{ item.Note }}</strong> /100</p>
        </div> 
        ...
        return{
            items:[
                {   
                    ...
                    Skill:'Reaction',
                    Note:'80',
                    Background:'var(--Light_red_back)',
                    Tcolor:'var(--Light_red)'
                },
                {   
                    id:1,
                    ...
                    Skill:'Memory',
                    Note:'92',
                    Background:'var(--Orengy_Yellow_back)',
                    Tcolor:'var(--Orengy_Yellow)'
                },
                {   
                    id:2,
                    ...
                    Skill:'Verbal',
                    Note:'61',
                    Background:'var(--green_teal_back)',
                    Tcolor:'var(--green_teal)'
                },
                {   
                    id:3,
                    ...
                    Skill:'Visual',
                    Note:'72',
                    Background:'var(--cobalt_blue_back)',
                    Tcolor:'var(--cobalt_blue)'
                },
